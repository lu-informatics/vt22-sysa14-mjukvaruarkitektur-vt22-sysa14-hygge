...
.header {
	...
	height: 100vh;
	background-image:
		url(https://miro.medium.com/max/1200/1*OEnS6-DEn56szCwdOs2mrA.jpeg);
		...
		<div class="header">
			...
			<div class="text-box">
				<center>
					...
					<h1>Who is Hygge</h1>
					<p>~ Learn about how five student started a leading dating app
						~</p>
					<p>&nbsp;</p>
					<p>
						<small>Hygge Inc. was originally established in 2022 by
							five students at Ekonomihögskolan at Lund University. The idea
							behind the company is that dating should be fun and easy. We saw
							the lack in a good dating application where the look should not
							determine whether it would be a match or not, instead, we thought
							the determination should be based on interests and the individual
							goal of a relationship. Hygge is the modern way to interact with
							like-minded people. Hygge allow the user- the flexibility to
							narrow its search based on education and interests to find a
							match with someone with the same background.</small>
					</p>
				</center>
			</div>
		</div>
