...
<!DOCTYPE html>
<html>
<body style="background-color: #4F55B4;">
...
<h2><span style="color:#FFFFFF;"> Welcome to test page!</span> </h2>
<h2> <span style="color:#FFFFFF;"> Click the button to test the facade!</span> </h2>
